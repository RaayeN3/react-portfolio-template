...
// @ts-ignore: allow importing 'ogl' without type declarations
...
const Prism = ({
  ...
  useEffect(() => {
    ...
    // clamp devicePixelRatio to limit GPU workload (lower quality on high-DPR devices)
    ...
    // Pause rendering while the user is actively scrolling to reduce jank.
    // Debounce restart so we don't thrash start/stop during continuous scroll.
